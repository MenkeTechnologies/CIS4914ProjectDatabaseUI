      ...
      <Grid container flexDirection={"column"}>
        ...
        <MenuItem>
          <ToggleButtonGroup
            ...
            exclusive
            onChange={event => {
              event.target.value === projectTypeSort ? setProjectTypeSort(null) : setProjectTypeSort(event.target.value)
            }}
          >
          ...
          <Grid container flexDirection={"row"} alignItems={"center"} justifyContent={"space-between"}>
            ...
            <Grid item>
              <ToggleButtonGroup
                ...
                exclusive
                onChange={event => {
                  event.target.value === projectDateSort ? setProjectDateSort(null) : setProjectDateSort(event.target.value)
                }}
              >
          ...
          <Grid container flexDirection={"row"} alignItems={"center"} justifyContent={"space-between"}>
            ...
            <Grid item>
              <Checkbox id={AVAILABILITY} checked={projectAvailabilitySort}
                        sx={{paddingRight: 0}}
                        onChange={event => {
                          event.target.value === projectAvailabilitySort ? setProjectAvailabilitySort(null) : setProjectAvailabilitySort(event.target.value)
                        }}/>
            </Grid>
          </Grid>
        </MenuItem>
          ...
          <Grid container flexDirection={"row"} alignItems={"center"} justifyContent={"space-between"}>
            ...
            <Grid item>
              <Checkbox id={ADVISOR_READY} checked={projectAdvisorSort}
                        sx={{paddingRight: 0}}
                        onChange={event => {
                          event.target.value === projectAdvisorSort ? setProjectAdvisorSort(null) : setProjectAdvisorSort(event.target.value)
                        }}/>
            </Grid>
          </Grid>
        </MenuItem>
