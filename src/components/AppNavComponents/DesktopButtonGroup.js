...
import { ALL_TAB, FACULTY_STATISTICS_TAB, MESSAGES_TAB, SEEKING_TAB, PROJECT_TAB, USER_POST_TAB, LIGHT_BLUE } from "../../util/Consts";
...
const DesktopButtonGroup = () => {
    ...
    return <Grid item>
        ...
        >
            <MenuItem style={{ backgroundColor: 'transparent' }}>
                <Grid container direction="column" alignItems={"center"}>
                    <Button type="text" color="inherit" size="small" fullWidth sx={{ ":hover": { backgroundColor: LIGHT_BLUE } }} onClick={(e) => handleRedirect(e, PROJECT_TAB)}>Project Post</Button>
                    <Button type="text" color="inherit" size="small" fullWidth sx={{ ":hover": { backgroundColor: LIGHT_BLUE } }} onClick={(e) => handleRedirect(e, SEEKING_TAB)}>Seeking Group Post</Button>
                </Grid>
            </MenuItem>
        </Menu>
        ...
        >
            <MenuItem style={{ backgroundColor: 'transparent' }}>
                <Grid container direction="column" alignItems={"center"}>
                    <Button type="text" color="inherit" fullWidth sx={{ ":hover": { backgroundColor: LIGHT_BLUE } }} size="small" onClick={(e) => handleRedirect(e, ALL_TAB)}>All Posts</Button>
                    <Button type="text" color="inherit" fullWidth sx={{ ":hover": { backgroundColor: LIGHT_BLUE } }} size="small" onClick={(e) => handleRedirect(e, USER_POST_TAB)}>My Posts</Button>
                </Grid>
            </MenuItem>
        </Menu>
        ...
        <ButtonGroup variant="text">
            ...
            <Button variant="text" color="inherit" size="small" onClick={handleNavChange(FACULTY_STATISTICS_TAB)}>Stats</Button>
