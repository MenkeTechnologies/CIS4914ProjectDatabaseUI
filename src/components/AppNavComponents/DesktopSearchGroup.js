import { Grid, Tooltip, IconButton, Menu, MenuItem, ToggleButtonGroup, ToggleButton, Typography, Checkbox, Divider, Input, InputAdornment } from "@mui/material"
    ...
    const handleSortByChange = (e, newSort) => {
        ...
        switch (e.target.id) {
            ...
            case ADVISOR_READY:
                ...
                break;
            default: console.log("Error with sort selection:" + e.target.id);
        }
    };
    ...
    return <Grid item xs={4}>
        <Grid container justifyContent={"flex-end"}>
                    ...
                    <Grid item>
                        <MenuItem>
                            <Grid container alignItems={"center"} justifyContent={"space-between"}>
                                ...
                                <Checkbox id={AVAILABILITY} checked={projectAvailabilitySort} onChange={handleSortByChange} sx={{ paddingRight: 0 }} />
                            </Grid>
                        </MenuItem>
                    </Grid>
                    <Grid item>
                        <MenuItem>
                            <Grid container alignItems={"center"} justifyContent={"space-between"}>
                                ...
                                <Checkbox id={ADVISOR_READY} checked={projectAdvisorSort} onChange={handleSortByChange} sx={{ paddingRight: 0 }} />
                            </Grid>
                        </MenuItem>
                    </Grid>
                </Grid>
            ...
            <Input
                ...
                variant="search"
                sx={{ color: "white", ':before': { borderBottomColor: 'transparent' }, ':hover:not(.Mui-disabled):before': { borderBottomColor: GREYED_BLUE + ' !important' }, ':after': { borderBottomColor: 'white' } }}
                endAdornment={
                    <InputAdornment position="end">
                        <IconButton onClick={handleSearchClear} sx={{ color: searchString === "" ? 'transparent' : 'white', padding: 0 }}>
